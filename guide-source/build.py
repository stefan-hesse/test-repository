...
# ── AUTO-TRANSLATE ────────────────────────────────────────────────────────
# Called in Step 1 of main(). Requires DEEPL_API_KEY env variable.
...
def run_auto_translate():
    ...
    if total_changed > 0:
        for lang in LANGUAGES:
            if lang["code"] == "en":
                continue
            lang_codes = {"it": "IT", "es": "ES", "fr": "FR", "de": "DE", "pt": "PT-BR", "th": "TH", "vi": "VI", "zh": "ZH-HANS"}
            lang_names = {"it": "Italian", "es": "Spanish", "fr": "French", "de": "German", "pt": "Portuguese (Brazil)", "th": "Thai", "vi": "Vietnamese", "zh": "Chinese (Simplified)"}
...
LANGUAGES = [
    ...
    },
    {
        "code":    "vi",
        "suffix":  "-vi",
        "source":  "guide-source/Avatour User and Best Practices Guide - VI.md",
        "webflow": "https://avatour.com/user-guide-vi",
        "title":   "Hướng dẫn Người dùng và Thực hành Tốt nhất của Avatour",
    },
    {
        "code":    "zh",
        "suffix":  "-zh",
        "source":  "guide-source/Avatour User and Best Practices Guide - ZH.md",
        "webflow": "https://avatour.com/user-guide-zh",
        "title":   "Avatour 用户指南与最佳实践",
    },
]
...
# ── CSS ───────────────────────────────────────────────────────────────────
CSS = """
@import url('https://fonts.googleapis.com/css2?family=Titillium+Web:wght@300;400;600;700&family=Roboto:wght@300;400;500&family=Sarabun:wght@300;400;500;600;700&family=Noto+Sans+SC:wght@300;400;500;600;700&display=swap');
...
body {
  font-family: 'Roboto', 'Sarabun', 'Noto Sans SC', sans-serif;
...
.sidenav-section {
  font-family: 'Titillium Web', 'Sarabun', 'Noto Sans SC', sans-serif;
