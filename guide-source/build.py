...
/* TOC: sticky in grid layout — works because grid rows scroll with page */
.guide-toc {
  grid-column: 2;
  position: sticky;
  top: 20px;
...
// Fix anchor links inside iframe — intercept clicks and scroll with offset
// SCROLL_OFFSET: pixels to subtract from scroll position.
// Accounts for the Webflow site header visible above the iframe.
