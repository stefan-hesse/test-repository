...
/* TOC: fixed at top of viewport — WEBFLOW_HEADER_HEIGHT must match
   the actual combined height of Webflow nav bars on avatour.com */
.guide-toc {
  position: fixed;
  width: 190px;
...
// ── ANCHOR LINKS ───────────────────────────────────────────────────────
// The parent Webflow page controls scrolling. We send the target's offset
// within the iframe; the Webflow head script adds the iframe top offset
// and scrolls the parent page.
