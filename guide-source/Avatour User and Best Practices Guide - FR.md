...
##### Accéder à un espace de travail Avatour (sans rejoindre une réunion Avatour)
...
2. **Espaces de travail (asynchrones) :** examinez les ressources et interagissez avec elles à votre rythme, 24 h/24 et 7 j/7.
...
- **Informations sur la réunion** – Consultez le code de la réunion, le lien d’invitation et accédez aux tutoriels associés.  
...
Lorsque vous présentez une ressource lors d’une réunion, la **barre d’outils des ressources** s’affiche au-dessus du canevas. Voici les outils et les éléments de menu disponibles lors de la <u>présentation d’une ressource lors d’une réunion</u> – expliqués de gauche à droite.
...
- **Notes** – Créez des notes associées à des moments précis de la ressource. Les notes peuvent être classées par catégorie (Observation, Problème, Action, Recommandation), suivies par statut (En attente → En cours → Résolue) et partagées via des liens directs. Si le contenu comporte un tracé GPS, les notes affichent également les coordonnées GPS. 
...
- **Panneau « Notes et résumé »** – Ouvre un panneau latéral affichant toutes les notes, les thèmes clés et un résumé de l’actif. Cliquer sur un élément vous amène à ce moment précis de la vidéo.  
...
![Menu Avatour lors de la présentation d’un ressource en dehors d’une réunion, par exemple lors de la consultation d’un espace de travail](https://res.cloudinary.com/avatour/image/upload/avatour-screenshot-present-asset-menu-workspace_iri8gc.png) *Menu Avatour lors de la présentation d’un élément dans un espace de travail*

- **Timeline vidéo / Barre de progression** – Affiche la progression de la vidéo avec les notes et les thèmes clés extraits de la piste audio. Cliquez n’importe où sur la timeline pour parcourir la vidéo. Cliquez sur une note ou un sujet pour accéder directement à ce moment et ouvrir la note. Comprend les commandes **Lecture / Pause**.  
- **Instantané, Notes, Panneau des notes et du résumé, Partager le lien, Sous-titres**  
...
- Commandes supplémentaires :
  ...
  - **Découper la vidéo** – Découper le début ou la fin de la vidéo
...
Vous pouvez ici consulter les détails de votre compte, gérer les utilisateurs enregistrés et importer des modèles d’inspection pour générer des rapports d’espace de travail (voir ci-dessus).

![Console Web Avatour - Élément du menu principal « Compte »](https://res.cloudinary.com/avatour/image/upload/v1781172273/avatour-screenshot-main-menu-account-1-of-2_oq5amr.jpg) *Aperçu du compte*
...
3. Commencez à utiliser Avatour sur place (en dehors de vos bureaux), sur le lieu de réunion où les participants à distance devraient normalement se rendre. D’autres problèmes de connectivité pourraient survenir ; Avatour vous aidera en collaboration avec votre équipe informatique.
4. Commencez à l’utiliser avec des participants à distance, tant internes qu’externes.
...
- Chargez tous les composants du kit pendant au moins 90 minutes avant la réunion en direct. Nous vous recommandons de toute façon de laisser tous les appareils en charge continue lorsqu’ils ne sont pas utilisés. Ainsi, tous les appareils seront toujours prêts, même pour des réunions imprévues et ponctuelles.
...
- Si vous savez que la connexion et la qualité vidéo vont se dégrader lorsque vous vous déplacerez vers un endroit précis (par exemple : en passant d’une zone de production intérieure à une zone extérieure), prévenez les participants à distance à l’avance.

- Si vous devez montrer quelque chose avec un niveau de détail élevé ou du texte en petits caractères, vous pouvez vous approcher très près avec la caméra à 360° ; vous pouvez également utiliser votre propre smartphone ou celui d’un participant sur place pour rejoindre la réunion et présenter la caméra (arrière) de votre téléphone ou du sien.
