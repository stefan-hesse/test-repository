...
> **Remarque :** pour rejoindre une réunion Avatour, vous devez **autoriser l’accès au microphone**. Veuillez accepter toutes les demandes d’autorisation affichées par votre navigateur.
...
1. **Via une invitation de calendrier (recommandé) :** 
 - Vous recevrez généralement une **invitation de calendrier** contenant un **lien de participation direct** (par exemple : `https://avatour.live/join?s=xxxxx`).  
   ...
   - **Authentification requise :** certaines réunions sont réservées aux utilisateurs inscrits. Dans ce cas, l’invitation indiquera que vous devez **vous connecter pour accéder à la réunion**.  
   - **Réunions protégées par mot de passe :** certaines réunions peuvent nécessiter un mot de passe. Dans ce cas, l’invitation inclura le mot de passe que vous devrez saisir pour vous connecter.
...
- **Espace de travail public :**  
  Si l’espace de travail est public, le lien est directement accessible — aucune connexion n’est requise.
...
1. **Réunions (synchrones) :** collaborez en temps réel avec d’autres participants, notamment lors de visites de site en direct ou en examinant ensemble des ressources enregistrées.  
...
![Menu inférieur des réunions Avatour](https://res.cloudinary.com/avatour/image/upload/avatour-screenshot-meeting-bottom-menu_bflaor.png)  
*Menu inférieur des réunions Avatour*
...
- **Microphone** – Activer ou désactiver votre micro.  
- **Présenter** – Présenter un élément, votre bureau ou le flux de votre webcam (voir la section « Présenter » ci-dessous).  
...
- **Passer en plein écran** – Affichez l'onglet de la réunion en plein écran.  
...
- **Infos sur la réunion** – Consultez le code de la réunion, le lien d’invitation et accédez aux tutoriels associés.  
...
Lorsque vous présentez une ressource lors d’une réunion, la **barre d’outils « Ressource »** apparaît au-dessus du canevas. Voici les outils et les éléments de menu disponibles lors de la <u>présentation d’une ressource lors d’une réunion</u> – expliqués de gauche à droite.
...
Lorsqu’une vidéo 360° en direct est diffusée lors d’une réunion, ce menu s’affiche au bas du canevas.
...
- **Chronologie vidéo / Barre de progression** – Affiche la progression de la vidéo avec des notes et les thèmes clés extraits de l’audio. Cliquez sur une note ou un thème pour accéder à ce moment précis et ouvrir la note. Comprend les commandes **Lecture / Pause**.   
...
- **Notes** – Créez des notes associées à des moments précis d’un contenu ou pendant un flux vidéo en direct. (N.B. : lors d’un direct, un élément = instantané sera automatiquement créé pour capturer la note). Chaque note possède un auteur et peut être classée par catégorie (Observation, Problème, Action, Recommandation), suivie par statut (Ouverte → En cours → Résolue), attribuée à un responsable et partagée via des liens directs. Si le fichier dispose d’un tracé GPS, les notes affichent également les coordonnées GPS. Les notes peuvent également être déplacées vers une autre position (glisser pour changer la position) et déplacées dans la timeline (avancer ou reculer dans la timeline).

  ![Notes Avatour et filtre de notes](https://res.cloudinary.com/avatour/image/upload/avatour-screenshot-present-asset-menu-meeting-showing-notes-and-filters_g181oc.png) *Notes Avatour et filtres de notes*

- **Notes de commande vocale** – Il s’agit de marqueurs de position générés automatiquement lorsque des expressions telles que « insérer une note », « prendre une note » ou « rédiger une note » sont détectées dans une vidéo enregistrée. Ces notes apparaissent sur la timeline et doivent être **positionnées et finalisées** par l’utilisateur. 
...
- **Sous-titres (CC)** – Affichez la transcription à l'écran pendant la lecture de la vidéo.
...
- Commandes supplémentaires :
  ...
  - **Vitesse de lecture** – Régler la vitesse (0,5×–2×)  
