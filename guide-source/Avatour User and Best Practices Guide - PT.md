...
2. **Por meio do código da reunião:** 
 - Se o anfitrião compartilhar um **código de reunião de 5 caracteres** separadamente, acesse [https://avatour.live/join](https://avatour.live/join), insira seu **nome** e o **código da reunião** e participe da reunião. 
...
Você pode participar de uma reunião e visitar um Workspace usando uma variedade de headsets compatíveis da Meta e da Pico. Para fazer isso: 

1. Instale nosso aplicativo Avatour na loja de aplicativos de RV de sua escolha: [Como instalar o aplicativo Avatour VR](https://avatour.com/support/which-vr-headsets-can-i-use-with-avatour)
...
- **Ferramentas do anfitrião** (somente para anfitriões):  
  - **Bloquear foco** – Bloqueie a visualização para todos os participantes.  
  - **Silenciar todos** – Silencie todos os participantes.  
- **Ativar tela cheia** – Colocar a guia da reunião em tela cheia.  
...
- **Mapa** – Abre ou fecha o painel do mapa para ativos com trilha de GPS. Clicar em um local leva ao ponto exato no vídeo. O mapa é atualizado em tempo real à medida que o vídeo é reproduzido.
- **Participantes** – Abre ou fecha o painel de participantes.  
...
- **Linha do tempo do vídeo / Barra de progresso** – Mostra o progresso do vídeo com notas e tópicos principais extraídos do áudio. Clique em uma nota ou tópico para saltar para aquele momento e abrir a nota. Inclui controles de **Reproduzir / Pausar**.   
...
- **Notas de comando de voz** – São marcadores de posição gerados automaticamente quando a gravação detecta menções como “inserir nota”, “anotar” ou “fazer uma nota”. Essas notas aparecem na linha do tempo e precisam ser **posicionadas e finalizadas** pelo usuário. 
...
- **Painel de notas e resumo** – Abre um painel lateral que exibe todas as notas, tópicos principais e um resumo executivo do ativo. Clicar em um item leva você para aquele momento no vídeo.  
  ...
  No **Painel Lateral**, você pode **imprimir um relatório de ativo** ou **baixá-lo como TXT ou CSV**. Os relatórios podem incluir notas, tópicos gerados por IA e transcrições completas. Você também pode **escolher quais elementos incluir** antes de exportar.  
...
- Não disponível: **Spotlight, POV** (estes requerem participantes ao vivo)  
...
- **Ambientes mais silenciosos / vários participantes próximos à câmera:** 
  Use o alto-falante clipável NoxGear. Ele não tem a mesma alta fidelidade dos alto-falantes de conferência (por exemplo, Jabra Speak), mas é fácil de prender na camisa e capta vozes próximas de forma eficaz.  
...
**Largura de banda recomendada:** 10 Mbps de upload/download para streaming completo em 360° (~5 Mbps). Largura de banda mais baixa (1–2 Mbps) só funciona quando você estiver parado.
...
- **Teste de deslocamento pelo local:** Na câmera: Configurações → Rede → Teste de conexão. Caminhe por todo o espaço para confirmar a cobertura e a largura de banda.
...
Quando vários participantes entram em uma reunião ao vivo do Avatour a partir do mesmo local que a câmera 360°, o gerenciamento cuidadoso do **áudio e da largura de banda** é crucial:  
...
Aqui estão (1) o Nível Superior, (2) Configurações e (3) Configurações de Rede.
...
- **Captura Rápida**: Ajuste suas configurações de Captura Rápida de acordo com a taxa de quadros de vídeo de sua preferência, a largura de banda disponível para uploads de vídeos gravados ou se as lentes de proteção da sua câmera estiverem instaladas. A Captura Rápida tem uma resolução definida de 4K, o que geralmente oferece um bom equilíbrio entre qualidade de vídeo e tamanho do arquivo. (Para resoluções mais altas, você pode usar os aplicativos nativos da câmera, também no PanoX V2; para mais detalhes, consulte [Como gravar e enviar vídeos 360 com o aplicativo Avatour?](https://avatour.com/support/how-do-you-record-and-upload-360-videos-with-the-avatour-app)):
  - **Taxa de quadros alvo**: Ajuste a taxa de quadros para suas gravações de vídeo com a Captura Rápida entre 15 fps, 24 fps e 30 fps. Taxas de quadros mais altas produzem um vídeo mais suave, mas aumentam o tamanho do arquivo de vídeo e o tempo de envio. Recomendado: 30 fps
  ...
  > Consulte também nossa [Calculadora de tamanho de arquivo de vídeo Avatour 360°](https://avatour.com/support/avatour-360deg-video-file-size-calculator) para obter mais orientações sobre as configurações acima e os tamanhos dos arquivos de vídeo.
