...
- **Participar de uma reunião no Avatour (colaboração síncrona):**  
  Você pode receber um **convite de calendário** para participar de uma reunião no Avatour. Durante a reunião, os participantes podem realizar uma **visita remota ao local em tempo real** ou analisar recursos em conjunto de forma síncrona.

- **Visitar um Espaço de Trabalho (Colaboração assíncrona):**  
  Você também pode ser convidado como **colaborador de um Espaço de Trabalho** para analisar ativos **de forma assíncrona** (conforme sua disponibilidade).
...
- **Espaço de Trabalho restrito:**  
  ...
  2. Clique no link do e-mail para abrir o Espaço de Trabalho. Caso ainda não esteja conectado, será solicitado que você **faça login ou conclua o cadastro**.
...
2. **Espaços de Trabalho (assíncronos):** revise e interaja com os recursos de acordo com sua própria programação, 24 horas por dia, 7 dias por semana.
...
![Interface do usuário de uma Reunião do Avatour com Painel de Recursos, tela em branco e Painel de Participantes](https://res.cloudinary.com/avatour/image/upload/avatour-screenshot-meeting-assets-blank-participants_pugprq.png)  
...
![Espaço de Trabalho do Avatour com Painel de Recursos, Área de Trabalho em branco e Painel de Reuniões](https://res.cloudinary.com/avatour/image/upload/avatour-screenshot-workspace-assets-blank-meetings_qeumpl.png)  
...
- **Câmera** – Ative ou desative sua webcam.  
- **Microfone** – Silencie ou reative o microfone.  
...
##### Barra de ferramentas de ativos (Reunião)
...
- **Notas** – Crie notas vinculadas a momentos específicos no recurso. As notas podem ser categorizadas (Observação, Problema, Ação, Recomendação), acompanhadas por status (Aberta → Em andamento → Resolvida) e compartilhadas por meio de links diretos. Se o recurso tiver um registro de GPS, as notas também exibirão as coordenadas GPS. 

  ![Nota do Avatour e Filtro de Notas](https://res.cloudinary.com/avatour/image/upload/avatour-screenshot-present-asset-menu-meeting-showing-note-and-filters_g181oc.png) *Notas do Avatour e Filtros de Notas*
...
- **Painel de notas e resumo** – Abre um painel lateral que exibe todas as notas, os principais tópicos e um resumo executivo do recurso. Clicar em um item leva você até aquele momento no vídeo. 
  ...
  *Menus de impressão/download do relatório de ativos do Avatour*  
  ...
  ![Seleção de elementos do relatório de ativos do Avatour para impressão](https://res.cloudinary.com/avatour/image/upload/avatour-screenshot-asset-report-element-selection_ud8c5k.png)  
...
##### Barra de ferramentas do recurso (Espaço de trabalho)

Ao revisar um recurso em um espaço de trabalho, a barra de ferramentas é semelhante, mas otimizada para uso individual:
...
- **Linha do tempo do vídeo / Barra de progresso** – Mostra o progresso do vídeo com notas e tópicos-chave extraídos da trilha de áudio. Clique em qualquer lugar da linha do tempo para avançar ou retroceder no vídeo. Clique em uma nota ou tópico para saltar para aquele momento e abrir a nota. Inclui controles de **Reproduzir / Pausar**.  
...
Aqui você pode ver os detalhes da sua conta e gerenciar usuários registrados, bem como fazer upload de modelos de inspeção para gerar relatórios do espaço de trabalho (veja acima).

![Avatour Web Console - Item do menu principal “Conta”](https://res.cloudinary.com/avatour/image/upload/v1781172273/avatour-screenshot-main-menu-account-1-of-2_oq5amr.jpg) *Visão geral da conta*
...
2. Leve o kit para o escritório e conecte-o à rede corporativa (podem surgir questões relacionadas à empresa, como firewalls corporativos — mas você já sabe, desde a etapa um, que o Avatour está funcionando, e esse é um assunto a ser resolvido pela sua equipe de TI com a ajuda da Avatour).
...
- Todos os componentes do kit devem ser carregados por pelo menos 90 minutos antes da reunião ao vivo. De qualquer forma, recomendamos manter todos os dispositivos em carregamento contínuo quando não estiverem em uso. Assim, todos os dispositivos estarão sempre prontos, inclusive para reuniões improvisadas e não planejadas.
...
- Verifique se a câmera 360 pode se conectar ao seu Wi-Fi local.

- Antes de uma reunião do Avatour, planeje o percurso que você fará pelas instalações. Faça uma reunião de teste do Avatour com a câmera e verifique se todas as áreas têm taxas de bits acima de 1 Mbps de largura de banda. Isso pode ser visto na própria tela da câmera ou, como participante remoto, acessando “Configurações” e ativando a opção “Mostrar taxa de bits”.

- Se você perceber que algumas áreas têm pouca ou nenhuma largura de banda, é melhor tirar fotos ou fazer uma gravação. Esses materiais podem então ser apresentados durante a reunião para que os participantes remotos possam analisá-los. Você pode seguir o guia acima, que explica nosso recurso “Captura Rápida” para gravação offline e envio de vídeos/imagens.

- Se houver participantes remotos na reunião que nunca tenham usado o Avatour antes, forneça a eles um breve resumo da plataforma, suas funcionalidades (vídeo ao vivo em 360°, recursos, capturas de tela, anotações, destaque) e as ferramentas da reunião.
...
- Se você planeja usar a câmera 360° em um ambiente com temperatura elevada, recomenda-se usar o módulo de resfriamento (apenas no Pilot Pano). Isso ajudará a reduzir as chances de a câmera superaquecer e desligar automaticamente.
...
- Nos casos em que a câmera precisar permanecer estável, use o tripé e ajuste a câmera na altura correta, de preferência ao nível dos olhos.
...
- Se precisar mostrar algo com muitos detalhes ou letras pequenas, você pode se aproximar bastante com a câmera de 360° e também usar seu próprio smartphone ou o de um participante no local para participar da reunião e exibir a câmera (traseira) do seu/dele.
...
- As recomendações acima, não relacionadas à conectividade, também se aplicam, em geral, à gravação offline (por exemplo, vá devagar)
...
- Abaixe a câmera e aponte para os elementos que deseja destacar. Se você definir o “Direction Lock” (Bloqueio de direção) como “No” (Não), poderá até mesmo apontar para algo com a câmera 360° (por exemplo, usando a lente frontal).  
