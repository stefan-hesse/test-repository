...
Present - see Present menu below

Host Tools (for host only): 
...
Geo Location - For assets and live streaming with GPS open/close the map pane.
...
```markdown
Camera - Allows you to share your webcam or smartphone/tablet camera.
